    ...
    <div class="query-form">
      <el-form ref="queryFormRef" :inline="true" :model="query">
        ...
        <el-form-item label="菜单状态" prop="menuState">
          <el-select v-model="query.menuState" placeholder="菜单状态">
        ...
        <el-form-item>
          ...
          <el-button @click="handelRest('queryFormRef')"> 重置 </el-button>
        </el-form-item>
      </el-form>
    </div>
    <div class="base-table">
      <div class="action">
        <el-button v-has="'menu-add'" type="primary" @click="showForm('create', 'level1', {})"> 新增 </el-button>
      </div>
      <el-table :data="menuList" row-key="_id" :tree-props="{ children: 'children' }">
        ...
        <el-table-column label="操作" width="240">
          <template #default="scope">
            <el-button v-has="'menu-add'" @click="showForm('create', 'other', scope.row)"> 新增 </el-button>
            <el-button v-has="'menu-edit'" @click="showForm('edit', '', scope.row)"> 编辑 </el-button>
            <el-button v-has="'menu-delete'" type="danger" @click="userDel(scope.row)"> 删除 </el-button>
          </template>
        </el-table-column>
      </el-table>
    </div>
    <!-- 添加菜单-->
    <el-dialog v-model="menuFormVisible" :title="formMethod === 'edit' ? '编辑菜单' : '新增菜单'">
      <el-form ref="menuFormRef" :model="menuForm" :label-width="formLabelWidth" :rules="rules">
        ...
        <el-form-item v-show="menuForm.menuType === 1" prop="icon" label="菜单图标">
        ...
        <el-form-item v-show="menuForm.menuType === 1" label="组件路径" prop="component">
          <el-input v-model="menuForm.component" placeholder="请选择填写组件路径" />
        </el-form-item>
        <el-form-item v-show="menuForm.menuType === 1" prop="menuState" label="菜单状态">
          <el-radio-group v-model="menuForm.menuState" placeholder="请选择菜单状态">
